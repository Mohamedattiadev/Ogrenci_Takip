      ...
      <div className="flex gap-2">
        {FORMATS.map((format) => (
          <button
            key={format}
            type="button"
            className="rounded-md border border-neutral-200 px-3 py-1.5 text-xs font-semibold text-neutral-600 hover:border-brand-300 hover:bg-brand-50 hover:text-brand-700"
          >
            {format}
          </button>
        ))}
